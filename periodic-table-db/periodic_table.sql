...
--
-- Name: properties properties_fkey_atomic_number; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_fkey_atomic_number FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
